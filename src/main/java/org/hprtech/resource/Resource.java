...
public class Resource {
    ...
    public Response getCourseList(){
        return Response.ok("Course List: CS ME EE "+securityIdentity.getPrincipal().getName())
                .build();
    }
    @GET
    ...
    public Response addCourse(){
        return Response.ok("Added Course: CE").build();
    }
    @GET
    @RolesAllowed("admin")
    @Path("/update_course")
    ...
    public Response updateCourse(){
        return Response.ok("Updated Course: CE -> CSE").build();
    }
